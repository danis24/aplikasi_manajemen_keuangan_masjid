			...
			<div class="module-body">
				<form class="form-horizontal row-fluid" method="POST">
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="basicinput" name="id_pengeluaran" value="<?php echo $hasilkode?>" class="span3" readonly="readonly">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" id="basicinput" name="pengeluaran" class="span4" value="0" onkeyup="validasiAngka(this);" onblur="validasi_numstring(this);">
						</div>
					</div>
