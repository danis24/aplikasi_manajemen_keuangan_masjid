	...
	<div class="content">
		<div class="module">
			...
			<div class="module-body">
				...
				<div class="module-body">
					<form class="form-horizontal row-fluid" action="report.php?page=report_all_zakat_mal" method="POST" target="blank">
				...
				<div class="module-body">
					<form class="form-horizontal row-fluid" action="report.php?page=report_per_zakat_mal" method="POST" target="blank">
					<div class="control-group">
				...
				<div class="module-body">
					<form class="form-horizontal row-fluid" action="report.php?page=report_zakat_mal" method="POST" target="blank">
					<div class="control-group">
						<div class="controls">
							<input type="text" name="id_zakat_mal" class="span4" placeholder="Kode Zakat">
							<input type="submit" name="cetaksemua" class="btn btn-success" value="Cetak PDF">
						</div>
					</div>
					</form>
