			...
			<div class="module-body">
				...
				<div class="module-body">
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="harga_emas" class="input_angka" onkeyup="validasiAngka(this); zc_mal_nisab(); zc_mal_hitung();" onblur="validasi_numstring(this);" value="511.000,00" />	
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="harga_perak" class="input_angka" onkeyup="validasiAngka(this); zc_mal_nisab(); zc_mal_hitung();" onblur="validasi_numstring(this);" value="11.000,00" disabled="disabled" />	
						</div>
					</div>
					<div class="control-group">
				...
				<div class="module-body">
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="uang_tabungan" class="input_angka" onkeyup="validasiAngka(this); zc_mal_total_harta();" onblur="validasi_numstring(this);" />
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="saham" class="input_angka" onkeyup="validasiAngka(this); zc_mal_total_harta();" onblur="validasi_numstring(this);" />
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="piutang" class="input_angka" onkeyup="validasiAngka(this); zc_mal_total_harta();" onblur="validasi_numstring(this);" />		
						</div>
					</div>
					<div class="control-group">
				...
				<div class="module-body">
					...
					<div class="control-group">
						...
						<div class="controls">
							Rp <input type="text" id="hutang" class="input_angka" onkeyup="validasiAngka(this); zc_mal_total_kewajiban();" onblur="validasi_numstring(this);" />	
						</div>
					</div>
					<div class="control-group">
